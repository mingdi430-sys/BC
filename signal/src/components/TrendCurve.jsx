...
export function Curve({ series, xweeks = trendWeeks, from = 0, h = 260, bands = [], peakIdx = null, todayIdx = null, compact = false }) {
  ...
  return (
    <div className="tc-wrap">
      <svg className="tc" viewBox={`0 0 ${W} ${H}`} role="img" aria-label="검색 지수 추이"
        ...
        {todayIdx != null && <g><line x1={xs(todayIdx)} x2={xs(todayIdx)} y1={m.t} y2={H - m.b} stroke="#91a1bb" strokeDasharray="4 4" /><text x={xs(todayIdx) + 4} y={m.t + 10} className="forecast-label">오늘</text></g>}
